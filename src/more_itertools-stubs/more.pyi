...
@overload
def numeric_range(
    __start: datetime, __stop: datetime, __step: timedelta
) -> Iterator[datetime]: ...
def count_cycle(
...
def filter_except(
    validator: Callable[[_T], Any], iterable: Iterable[_T], *exceptions: Type[Exception]
) -> Iterator[_T]: ...
def map_except(
    function: Callable[[_T], _U], iterable: Iterable[_T], *exceptions: Type[Exception]
) -> Iterator[_U]: ...
