...
async def create_or_update(cls: Type[_CM], *, set_: Union[Sequence[str], Mapping[str, str]], **values: Any) -> _CM:
    column_name_map = cls._column_name_map

    index_elements: List[str] = [column_name_map[k] for k in cls.__table__.primary_key.columns.keys()]
