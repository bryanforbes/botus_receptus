...
class Connection:
    ...
    async def add_listener(
        self, channel: str, callback: Callable[['Connection', int, str, Any], Any]
    ) -> None: ...
    async def remove_listener(
        self, channel: str, callback: Callable[['Connection', int, str, Any], Any]
    ) -> None: ...
    def add_log_listener(
        self, callback: Callable[['Connection', PostgresLogMessage], Any]
    ) -> None: ...
    ...
    def cursor(
        self, query: str, *args, prefetch: int = ..., timeout: float = ...
    ) -> CursorFactory: ...
    async def prepare(
