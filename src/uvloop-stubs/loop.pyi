from typing import Any, Optional, Union, Callable, Awaitable, Generator, TypeVar, List, Tuple, Sequence, Dict, overload
import asyncio
import ssl
...
class Loop:
    ...
    def call_soon_threadsafe(self, callback: Callable[..., Any], *args: Any) -> asyncio.Handle: ...
    def call_later(self, delay: float, callback: Callable[..., Any], *args: Any) -> asyncio.Handle: ...
    def call_at(self, when: float, callback: Callable[..., Any], *args: Any) -> asyncio.Handle: ...
    def time(self) -> float: ...
    def stop(self) -> None: ...
    ...
    def create_task(self, coro: Union[Awaitable[_T], Generator[Any, None, _T]]) -> asyncio.Task[_T]: ...
    def set_task_factory(self, factory: Optional[Callable[[asyncio.AbstractEventLoop, Generator[Any, None, _T]],
                                                          asyncio.Future[_T]]]) -> None: ...
    def get_task_factory(self) -> Optional[Callable[[asyncio.AbstractEventLoop, Generator[Any, None, _T]],
                                                    asyncio.Future[_T]]]: ...
    @overload
    ...
    @asyncio.coroutine
    def create_server(self, protocol_factory: _ProtocolFactory, host: Union[str, Sequence[str]] = ...,
                      port: int = ..., *, family: int = ..., flags: int = ...,
                      sock: Optional[socket] = ..., backlog: int = ..., ssl: _SSLContext = ...,
                      reuse_address: Optional[bool] = ...,
                      reuse_port: Optional[bool] = ...) -> Generator[Any, None, asyncio.AbstractServer]: ...
    @asyncio.coroutine
    def create_connection(self, protocol_factory: _ProtocolFactory, host: str = ..., port: int = ..., *,
                          ...
                          sock: Optional[socket] = ..., local_addr: str = ..., server_hostname: str = ...) -> \
    ...
    @asyncio.coroutine
    def connect_accepted_socket(self, protocol_factory: _ProtocolFactory, sock: socket, *,
                                ssl: _SSLContext = ...) -> Generator[Any, None, _TransProtPair]: ...
    @asyncio.coroutine
    ...
    def subprocess_exec(self, protocol_factory: _ProtocolFactory, *args: Any, stdin: Any = ...,
                        ...
                        **kwargs: Any) -> Generator[Any, None, _TransProtPair]: ...
    @asyncio.coroutine
    def connect_read_pipe(self, protocol_factory: _ProtocolFactory, pipe: Any) -> \
        Generator[Any, None, _TransProtPair]: ...
    @asyncio.coroutine
    def connect_write_pipe(self, protocol_factory: _ProtocolFactory, pipe: Any) -> \
        Generator[Any, None, _TransProtPair]: ...
